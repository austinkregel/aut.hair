    ...
    <AppLayout title="Dashboard">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow sm:rounded-lg overflow-y-scroll" style="max-height: 280px;">
                        ...
                        <li v-for="activityItem in activityItems" :key="activityItem.id" class="py-4">
                            <div class="flex space-x-3 px-4">
                                ...
                                <div class="flex-1 space-y-1">
                                    ...
                                    <p class="text-sm text-gray-500">{{ prettyDate(activityItem.created_at) }}</p>
                                    </div>
                                    <p v-if="Object.keys(activityItem.properties).length !== 0" class="text-sm text-gray-500">{{ activityItem.properties }}</p>
                                </div>
                            </div>
                        </li>
                    </ul>
